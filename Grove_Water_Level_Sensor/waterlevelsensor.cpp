...
uint8_t WaterLevelSensor::getTouchedSections() {
...
int WaterLevelSensor::readPercentage() {
    return getTouchedSections() * 5;
}

float WaterLevelSensor::readCM() {
    return getTouchedSections() * 0.5f; //forces returning a float value instead of the default double return
}
